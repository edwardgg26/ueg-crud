...
class ActiveRecord {
    ...
    public function guardar() {
        $resultado = '';
        if(!is_null($this->id)) {
            if(isset($this->first_time) && $this->first_time === true){
    ...
    // Busqueda Order con Columna y un limite
    ...
    //Traer total de registros con un array where
